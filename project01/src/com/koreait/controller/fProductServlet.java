...
@WebServlet("/fProductServlet")
public class fProductServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public fProductServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println("fProductServlet에서 요청을 받음을 확인 : " + command);
