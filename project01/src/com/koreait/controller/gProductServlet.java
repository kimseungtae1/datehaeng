...
@WebServlet("/gProductServlet")
public class gProductServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public gProductServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println("gProductServlet에서 요청을 받음을 확인 : " + command);
