...
<script type="text/javascript" src="${contextPath }/js/member.js?ver=2"></script>
<style>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td height="142" align="left" valign="middle"><img src="${contextPath}/images/join_02_r.gif" width="227" height="142"></td>
  ...
  <tr>
    ...
    <tr><td height="1" colspan="4"><img src="${contextPath}/images/join_line.gif" width="800" height="1"></td></tr>
  <tr>
    <td height="50" colspan="4" align="center" valign="middle" class="join">JOIN</td>
    </tr>
    <tr><td height="1" colspan="4"><img src="${contextPath}/images/join_line.gif" width="800" height="1"></td></tr>
    <tr><td height="50" colspan="4"></td></tr>
  <tr>
    <!-- <td width="100" height="40" align="center" valign="middle">이름</td>
    <td height="36" colspan="3"><input type="text" size="10" name="mName"></td> -->
    <td width="100" height="40" align="center" valign="middle">아이디</td>
    <td width="100" height="40"><input type="text" size="20" name="mUserid"><input type="hidden" name="reid" size="20"></td>
    <td width="58" align="left" valign="middle"><a href="#"><img src="${contextPath}/images/checkId.jpg" onclick="idCheck()"></a></td>
    <td width="349" class="stress"> (영문 소문자 / 숫자 4~20)</td>
  </tr>
  <tr>
    <!-- <td width="100" height="40" align="center" valign="middle">생년월일</td>
    <td height="36" colspan="3"><input type="text" size="10" name="mBirth"></td> -->
    <td width="100" height="40" align="center" valign="middle">비밀번호</td>
    <td height="40" colspan="3"><input type="password" size="30" name="mPw"> 
      <span class="stress">(영문 대소문자 / 숫자 / 특수문자 4~30)</span></td>
  </tr>
   <tr>
    <!-- <td width="100" height="40" align="center" valign="middle">성별</td>
    <td height="36" colspan="3"><label><input type="radio" name="mGender" value="Y" /> 남자</label>
     <label><input type="radio" name="mGender" value="N" checked="checked" />여자</label></td> -->
     <td width="100" height="40" align="center" valign="middle">비밀번호 확인</td>
    <td height="40" colspan="3"><input type="password" size="30" name="mPwCheck"></td>
  </tr>
  <tr>
    <td width="100" height="40" align="center" valign="middle">이름</td>
    <td height="36" colspan="3"><input type="text" size="10" name="mName"></td>
  ...
  <tr>
    <td width="100" height="40" align="center" valign="middle">휴대전화</td>
    <td height="40" colspan="3"><input type="text" name="mPhone" size="20"></td>
  </tr>
  <tr>
    <td width="100" height="40" align="center" valign="middle">주소</td>
    <td height="40" colspan="3"><input type="text" size="50" name="mAddress"></td>
  </tr>
   <tr>
    <td width="100" height="40" align="center" valign="middle">성별</td>
    <td height="36" colspan="3"><label><input type="radio" name="mGender" value="남자" /> 남자</label>
     <label><input type="radio" name="mGender" value="여자" checked="checked" />여자</label></td>
  </tr>
  <tr>
    <td width="100" height="40" align="center" valign="middle">이메일</td>
    <td height="40" colspan="3"><input type="text" name="mEmail" size="20">수신여부
    				<label><input type="radio" name="mail" value="Y" /> 동의</label>
     <label><input type="radio" name="mail" value="N" checked="checked" />거부</label></td>
  </tr>
 <tr>
    <td height="50" colspan="4" align="center" valign="bottom"><input type="submit" value="회원가입">
