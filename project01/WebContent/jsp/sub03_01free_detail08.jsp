...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath }/images/sub03_01free_keyimg08.gif); background-repeat:no-repeat; background-size:100% 100%;}
...
<div class="message">
  <ul>
    <li><img src="${contextPath }/${contextPath }/images/sub_addMenu_home.png" onmouseover='this.src="${contextPath }/${contextPath }/images/sub_addMenu_home_r.png"' onmouseout='this.src="${contextPath }/${contextPath }/images/sub_addMenu_home.png"' onclick="location.href='${contextPath}/index.jsp'" style="cursor:pointer;"/></li>
  ...
  <tr>
    ...
    <c:choose>
  	<c:when test="${empty loginUser }">
  		<td width="47" height="12" align="left" valign="top"><img src="${contextPath }/images/subpage_login.png" 
  		onmouseover='this.src="${contextPath }/images/subpage_login_r.png"' onmouseout='this.src="${contextPath }/images/subpage_login.png"' 
  		onclick="location.href='${contextPath}/login.do'" style="cursor:pointer;"></td>
    	<td width="57" height="12" align="right" valign="top"><img src="${contextPath }/images/subpage_join.png" 
    	onmouseover='this.src="${contextPath }/images/subpage_join_r.png"' onmouseout='this.src="${contextPath }/images/subpage_join.png"' 
    	onclick="location.href='${contextPath}/join.do'" style="cursor:pointer;"></td>  
  	</c:when>
  	<c:otherwise>
	    ...
	    onmouseout='this.src="${contextPath }/images/sub_mypageBtn.gif"' onclick="location.href='MypageServlet'" style="cursor:pointer;"></td>
  	</c:otherwise>
  </c:choose>
    <td width="300" height="105" rowspan="3" align="center" valign="top"></td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath }/images/sub03_01free_detail08_startPic.gif" width="607" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath }/images/sub03_01free_detail08_pic01.gif" width="1302" height="1775"></td>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1572"><img src="${contextPath }/images/sub03_01free_detail08_pic02.gif" width="1622" height="623"></td>
...
<div id="detail_02">
<table width="1900" height="468" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><img src="${contextPath }/images/sub03_01free_detail08_pic03.gif"></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="4854" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="139"></td>
    <td align="center" valign="top" width="1622"><img src="${contextPath }/images/sub03_01free_detail08_pic04.gif" width="1622" height="4854"></td>
    <td align="center" valign="top" width="139"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="464" height="397" align="center" valign="top"></td>
    <td width="1067" height="397" align="center" valign="top"><img src="${contextPath }/images/sub03_01free_detail08_pic05.gif" width="989" height="397"></td>
    <td width="369" height="397" align="center" valign="top"></td>
  </tr>
  </table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="271" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="733"></td>
    <td align="center" valign="top" width="440"><img src="${contextPath }/images/sub03_01free_detail08_pic06.gif" width="440" height="271"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath }/images/sub03_01free_detail08_pic07.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
