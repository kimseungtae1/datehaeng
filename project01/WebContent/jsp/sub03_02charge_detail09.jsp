...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath }/images/sub03_02charge_keyimg09.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_03 { background-image:url(${contextPath }/images/sub03_02charge_detail05_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_03{height:3438px; text-align:center;}
...
<div class="message">
  <ul>
    <li><img src="${contextPath }/images/sub_addMenu_home.png" onmouseover='this.src="${contextPath }/images/sub_addMenu_home_r.png"' 
    onmouseout='this.src="${contextPath }/images/sub_addMenu_home.png"' onclick="location.href='${contextPath}/index.jsp'" style="cursor:pointer;"/></li>
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
    ...
    <td width="62" height="57" rowspan="3" align="center" valign="top"><img src="${contextPath }/images/subpage_logo.png" onclick="location.href='${contextPath}/index.jsp'" style="cursor:pointer;"
    ></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="499" height="241" align="center" valign="top"><img src="${contextPath }/images/sub03_02charge_detail09_startPic.gif" width="499" height="241"></td>
    <td width="701" height="241" align="center" valign="top"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath }/images/sub03_02charge_detail09_pic01.gif" width="1302" height="1775"></td>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1555"><img src="${contextPath }/images/sub03_02charge_detail09_pic02.gif" width="1555" height="657"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="983"><img src="${contextPath }/images/sub03_02charge_detail09_pic03.gif" width="983" height="468"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="4002" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub03_02charge_detail09_pic04.gif" width="1500" height="4002"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="397" align="center" valign="top"><img src="${contextPath }/images/sub03_02charge_detail09_pic05.gif" width="983" height="397"></td>
    <td width="458" height="369" align="center" valign="top"></td>
  </tr>
  </table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="440"><img src="${contextPath }/images/sub03_02charge_detail09_pic06.gif" width="440" height="253"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath }/images/sub03_02charge_detail09_pic07.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
