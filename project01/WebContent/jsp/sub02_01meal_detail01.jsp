...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath}/images/sub02_01meal_detail01_kmg.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_03 { background-image:url(${contextPath}/images/sub02_01meal_detail01_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_03{height:136px; line-height:100px; text-align:center;}
	#bg_04 { background-image:url(${contextPath}/images/sub02_01meal_detail01_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_04{height:1150px; line-height:600px; text-align:center;}
	#bg_05 { background-image:url(images/sub03_01free_detail01_bg05.gif); background-repeat:no-repeat; background-size:100% 100%;}
    #bg_05{height:1095px; line-height:600px; text-align:center;}
    #bg_06 { background-image:url(images/sub03_01free_detail01_bg06.gif); background-repeat:no-repeat; background-size:100% 100%;}
    #bg_06{height:570px; line-height:600px; text-align:center;}
    #bg_07 { background-image:url(images/sub03_01free_detail01_bg07.gif); background-repeat:no-repeat; background-size:100% 100%;}
    #bg_07{height:136px; text-align:center;}
    #bg_08 { background-image:url(images/sub02_01meal_detail01_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
    ...
    <td width="62" height="57" rowspan="3" align="center" valign="middle"><img src="${contextPath}/images/subpage_logo.png" 
...
<input type="hidden" name="mctype" value="1">
  ...
  <tr>
    ...
    <td width="468" height="468" rowspan="8" align="center" valign="top">
    <img src="${contextPath }/jsp/upload/${mprod.mPicture }" width="468" height="468"></td>
    <td height="468" rowspan="8" align="center" valign="top"></td>
    <td width="144" height="10" align="left" valign="middle"></td>
    <td width="263" height="10" align="left" valign="middle">
  ...
  <tr>
    ...
    <td width="263" height="87" align="left" valign="top"><p class="productTitle">${mprod.mTitle }</p>
      <%-- <p class="productTitle">(구분 : ${mprod.mType })</p> --%></td>
  </tr>
  <tr>
  ...
  <tr>
    <%-- <td width="144" height="108" align="center" valign="middle"><img src="${contextPath}/images/sub02_01meal_detail_reserveBtn.gif" onmouseover='this.src="${contextPath}/images/sub02_01meal_detail_reserveBtn_r.gif"' onmouseout='this.src="${contextPath}/images/sub02_01meal_detail_reserveBtn.gif"' width="171" height="58" onclick="location.href=''" style="cursor:pointer;"></td>
    <td width="263" height="108" align="center" valign="middle"><img src="${contextPath}/images/sub02_01meal_detail_addCartBtn.gif" onmouseover='this.src="${contextPath}/images/sub02_01meal_detail_addCartBtn_r.gif"' onmouseout='this.src="${contextPath}/images/sub02_01meal_detail_addCartBtn.gif"' width="170" height="58" onclick="location.href='${contextPath }/CartServlet?command=cart_list'" style="cursor:pointer;"></td> --%>
    <!-- 바로예약 버튼 -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail01_startPic.gif" width="440" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail01_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="764"><img src="${contextPath}/images/sub02_01meal_detail01_pic02.gif" width="764" height="340"></td>
    <td align="center" valign="top" width="836"></td>
  </tr>
</table>
</td>
  </tr>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1612"><img src="${contextPath}/images/sub02_01meal_detail01_pic03.gif" width="1612" height="623"></td>
    <td align="center" valign="top" width="149"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="941"><img src="${contextPath}/images/sub02_01meal_detail01_pic04.gif" width="941" height="468"></td>
    <td align="center" valign="top" width="495"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="198"></td>
    <td align="center" valign="top" width="1504"><img src="${contextPath}/images/sub02_01meal_detail01_pic05.gif" width="1502" height="1126"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="879" height="879" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="230"></td>
    <td align="center" valign="top" width="1442"><img src="${contextPath}/images/sub02_01meal_detail01_pic06.gif" width="1442" height="879"></td>
    <td align="center" valign="top" width="228"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1137" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="198"></td>
    <td align="center" valign="top" width="1482"><img src="${contextPath}/images/sub02_01meal_detail01_pic08.gif" width="1482" height="1137"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="628"></td>
    <td align="center" valign="top" width="640"><img src="${contextPath}/images/sub02_01meal_detail01_pic07.gif" width="640" height="136"></td>
    <td align="center" valign="top" width="632"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="399" height="399" rowspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail01_pic09.gif" width="399" height="399"></td>
    <td width="26" height="399" rowspan="2" align="center" valign="top"></td>
    <td height="281" colspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail01_pic010.gif" width="549" height="281"></td>
    <td width="464" height="399" rowspan="2" align="center" valign="top"></td>
  </tr>
  <tr>
    <%-- <td width="170" height="118" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail_situationBtn.gif" onmouseover='this.src="${contextPath}/images/sub02_01meal_detail_situationBtn_r.gif"' onmouseout='this.src="${contextPath}/images/sub02_01meal_detail_situationBtn.gif"' width="170" height="58"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="440"><img src="${contextPath}/images/sub02_01meal_detail01_pic12.gif" width="440" height="253"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath}/images/sub02_01meal_detail01_pic14.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
