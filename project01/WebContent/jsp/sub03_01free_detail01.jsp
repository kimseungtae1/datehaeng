...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath}/images/sub03_01free_slide06.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_01 { background-image:url(${contextPath}/images/sub03_01free_detail01_bg01.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_01{height:1435px; line-height:600px; text-align:center;}
	...
	#bg_03 { background-image:url(${contextPath}/images/sub03_01free_detail01_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_03{height:1562px; text-align:center;}
	#bg_04 { background-image:url(${contextPath}/images/sub03_01free_detail01_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_04{height:1221px; line-height:100px; text-align:center;}
	#bg_05 { background-image:url(${contextPath}/images/sub03_01free_detail01_bg05.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_05{height:1095px; line-height:600px; text-align:center;}
	#bg_06 { background-image:url(${contextPath}/images/sub03_01free_detail01_bg06.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_06{height:570px; line-height:600px; text-align:center;}
	#bg_07 { background-image:url(${contextPath}/images/sub03_01free_detail01_bg07.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_07{height:136px; text-align:center;}
	#bg_08 { background-image:url(${contextPath}/images/sub02_01meal_detail01_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_08{height:1150px; line-height:600px; text-align:center;}
	#bg_09 { background-image:url(${contextPath}/images/sub_detail_review_bg.gif); background-repeat:no-repeat; background-size:100% 100%;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="638" height="241" align="center" valign="top"></td>
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath}/images/sub03_01free_detail01_startPic.gif" width="607" height="241"></td>
    <td width="655" height="241" align="center" valign="top"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath}/images/sub03_01free_detail01_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="764"><img src="${contextPath}/images/sub03_01free_detail01_pic02.gif" width="873" height="340"></td>
...
<div id="bg_02">
  ...
  <tr>
    <td align="center" valign="top" width="139" height="34"></td>
    <td align="center" valign="top" width="1572"><img src="${contextPath}/images/sub03_01free_detail01_pic03.gif" width="1622" height="623"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="621"><img src="${contextPath}/images/sub03_01free_detail01_pic04.gif" width="1900" height="468"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1126" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub03_01free_detail01_pic05.gif" width="1561" height="1126"></td>
    <td align="center" valign="top" width="139"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1948" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub03_01free_detail01_pic06.gif" width="1500" height="1948" usemap="#Map"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1562" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <td align="center" valign="top" width="1900" height="71" colspan="3"></td>
  </tr>
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub03_01free_detail01_pic07.gif" width="1500" height="1491"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1221" border="0" cellspacing="0" cellpadding="0">
    <tr>
  <td align="center" valign="top" width="1900" height="164" colspan="3"></td>
  </tr>
  <tr>
    <td align="center" valign="top" width="145"></td>
    <td align="center" valign="top" width="1610"><img src="${contextPath}/images/sub03_01free_detail01_pic08.png" width="1610" height="991"></td>
    <td align="center" valign="top" width="145"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1095" border="0" cellspacing="0" cellpadding="0">
     <tr>
  <td align="center" valign="top" width="1900" height="40" colspan="3"></td>
  </tr>
  <tr>
    <td align="center" valign="top" width="186"></td>
    <td align="center" valign="top" width="1528"><img src="${contextPath}/images/sub03_01free_detail01_pic09.png" width="1528" height="946"></td>
    <td align="center" valign="top" width="186"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="570" border="0" cellspacing="0" cellpadding="0">
     <tr>
  <td align="center" valign="top" width="1900" height="46" colspan="3"></td>
  </tr>
  <tr>
    <td align="center" valign="top" width="638"></td>
    <td align="center" valign="top" width="1559"><img src="${contextPath}/images/sub03_01free_detail01_pic10.png" width="1559" height="470"></td>
    <td align="center" valign="top" width="641"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="464" height="397" rowspan="2" align="center" valign="top"></td>
    <td width="399" height="397" rowspan="2" align="center" valign="top"><img src="${contextPath}/images/sub03_01free_detail01_pic12.gif" width="397" height="397"></td>
    <td width="26" height="397" rowspan="2" align="center" valign="top"></td>
    <td height="281" align="center" valign="top"><img src="${contextPath}/images/sub03_01free_detail01_pic13.gif" width="602" height="300"></td>
    <td width="416" height="397" rowspan="2" align="center" valign="top"></td>
  </tr>
  <tr>
...
<script type="text/javascript"> 
                          var oPoint = new nhn.api.map.LatLng(${mprod.fMapX}, ${mprod.fMapY}); /* 37.278697, 127.015872 */
...
var oMarker = new nhn.api.map.Marker(oIcon, { title : '${mprod.fMapTitle1}, ${mprod.fMapTitle2}' });  //마커를 생성한다 행궁동, 멘야산타이메
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="440"><img src="${contextPath}/images/sub03_01free_detail01_pic14.gif" width="440" height="253"></td>
    <td align="center" valign="top" width="727"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath }/images/sub03_01free_detail01_pic15.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
...
<form action="fProductServlet" method="post">
<input type="hidden" name="command" value="fproduct_view">
<input type="hidden" name="mUserid" value="${loginUser.mUserid }">
<input type="hidden" name="fNo" value="${mprod.fNo }">
내용입력 &nbsp;&nbsp;&nbsp; <input type="text" name="frContext" size="120"> &nbsp;&nbsp;&nbsp; <input type="submit" value="등록">
</form>
</div>
</div>
  ...
  <tr>
    ...
    <!-- DB에서 리뷰 게시물을 불러오는 부분 입니다. -->
	  <c:forEach var="free_review" items="${FreeReviewList }">
	  <c:if test="${!empty free_review.frContext }">
		  <tr class="list">
		    <td width="136" height="35" align="center" valign="middle">★★★★</td>
		    <td width="88" align="center" valign="middle"></td>
		    <td width="721" height="35" align="center" valign="middle">${free_review.frContext }</td>
		    <td width="208" height="35" align="center" valign="middle">${free_review.mUserid }</td>
...
<!--  페이지 번호 시작 -->
    <div id="block6"></div>
     <div id="list" align="center">
			...
			<c:if test="${pageNum > 1 }">
				<a class="ho" href="fProductServlet?command=fproduct_view&fNo=${mprod.fNo}&pageNum=${pageNum-1 }&column=${param.column}&find=${find}#list">[이전]</a>&nbsp; 
			</c:if>
			<c:forEach var="a" begin="${startpage}" end="${endpage}">
				<c:if test="${a==pageNum}">[${a }]</c:if>
				<c:if test="${a !=pageNum}"><a class="ho" href="fProductServlet?command=fproduct_view&fNo=${mprod.fNo}&pageNum=${a }&column=${param.column}&find=${find}#list">[${a }]</a></c:if>
			</c:forEach>
			<c:if test="${pageNum >= maxpage}">[다음]</c:if>
			<c:if test="${pageNum < maxpage}">
				<a class="ho" href="fProductServlet?command=fproduct_view&fNo=${mprod.fNo}&pageNum=${pageNum+1}&column=${param.column}&find=${find}#list">[다음]</a>
			</c:if>
    </div>
    <!--  페이지 번호 끝  -->
  <div id="block7"></div>
...
<map name="Map">
  <area shape="rect" onFocus="blur()" coords="637,768,880,805" border="0" href="http://www.spacenoon.co.kr/" target="_blank">
</map>
</body>
</html>
