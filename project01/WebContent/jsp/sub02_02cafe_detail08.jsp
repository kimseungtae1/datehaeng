...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath }/images/sub02_02cafe_detail08_kmg.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#block13 {height:54px;}
	#block14 {height:73px;}
	#detail_07 a {text-align:center; color:#fff;}
	...
	#bg_03 { background-image:url(${contextPath }/images/sub02_02cafe_detail08_bg01.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_03{height:932px; line-height:100px; text-align:center;}
	#bg_04 { background-image:url(${contextPath }/images/sub02_01meal_detail01_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath }/images/sub02_02cafe_detail08_startPic.gif" width="440" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath }/images/sub02_02cafe_detail08_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="618"><img src="${contextPath }/images/sub02_02cafe_detail08_pic02.gif" width="618" height="340"></td>
    <td align="center" valign="top" width="987"></td>
  </tr>
</table>
</td>
  </tr>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1543"><img src="${contextPath }/images/sub02_02cafe_detail08_pic03.gif" width="1543" height="623"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="941"><img src="${contextPath }/images/sub02_02cafe_detail08_pic04.gif" width="941" height="468"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub02_02cafe_detail08_pic05.gif" width="1500" height="1189"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub02_02cafe_detail08_pic06.gif" width="1500" height="800"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="808" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="285"></td>
    <td align="center" valign="top" width="1332"><img src="${contextPath }/images/sub02_02cafe_detail08_pic07.gif" width="1332" height="808"></td>
    <td align="center" valign="top" width="283"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1448"><img src="${contextPath }/images/sub02_02cafe_detail08_pic08.gif" width="1448" height="1196"></td>
    <td align="center" valign="top" width="226"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="932" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="178"></td>
    <td align="center" valign="top" width="1543"><img src="${contextPath }/images/sub02_02cafe_detail08_pic09.gif" width="1543" height="932"></td>
    <td align="center" valign="top" width="179"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="399" height="399" rowspan="2" align="center" valign="top"><img src="${contextPath }/images/sub02_02cafe_detail08_pic10.gif" width="399" height="399"></td>
    <td width="26" height="399" rowspan="2" align="center" valign="top"></td>
    <td height="281" colspan="2" align="center" valign="top"><img src="${contextPath }/images/sub02_02cafe_detail08_pic11.gif" width="610" height="281"></td>
    <td width="408" height="399" rowspan="2" align="center" valign="top"></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="440"><img src="${contextPath }/images/sub02_02cafe_detail08_pic12.gif" width="440" height="253"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath }/images/sub02_02cafe_detail08_pic13.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
