...
function radioOk(){
	if(document.frm.yaok1.value == ""){
        alert("개인정보 수집·이용 사항을 선택해주세요."); 
        document.frm.yaok1.focus();
		return false;
	}else if(document.frm.yaok2.value == ""){
        alert("개인정보 수집·이용 사항을 선택해주세요."); 
        document.frm.yaok2.focus();
		return false;
	}else if(document.frm.yaok3.value == ""){
        alert("개인정보 수집·이용 사항을 선택해주세요."); 
        document.frm.yaok3.focus();
		return false;
	}
...
<body>
<form action="JoinServlet2" method="post" name="frm">
<div id="wrap">
<div id="block1"></div>
<!-- 드롭다운 시작 -->
<div id="menu">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr>
    <td height="142" align="left" valign="middle"><img src="${contextPath}/images/join_01_r.gif" width="260" height="142"></td>
    ...
    <td height="142" align="left" valign="middle"><img src="${contextPath}/images/join_03.gif" width="227" height="142"></td>
    </tr></table></td></tr>
</table>
</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
      <td align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="338" height="50" align="center"><table width="900" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="40"></td>
            </tr>
            <tr>
              <td height="60" valign="middle" colspan="4" class="joincheck">회원 가입을 하기에 앞서 회원약관을 읽어보시기 바랍니다.</td>
            </tr>
            <tr>
              <td colspan="4"><textarea name="textarea" cols="120" rows="10" readonly wrap="off">인터넷 쇼핑몰 『 데이트행(주)』회원 약관


제1조(목적)
이 약관은 데이트행(주) 회사(전자상거래 사업자)가 운영하는 데이트행(주) 사이버 몰(이하 "몰"이라 한다)에서 
...
제2조(정의)
①"몰" 이란 데이트행(주) 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 리아네이처(주) 사이버몰의 초기 서비스화면(전면)
...
본 약관은 2017년03월11일부터 적용됩니다.
          </textarea></td>
            </tr>
            <tr>
              <td height="40" valign="bottom"><strong>[필수]</strong> 개인정보 수집·이용</td>
            </tr>
            <tr>
              <td height="20"></td>
            </tr>
            <tr>
              <td width="220" height="42" align="center" class="tab">목적</td>
              <td width="338" height="42" align="center"class="tab">항목</td>
              <td width="174" height="42" align="center"class="tab">보유기간</td>
              <td width="168" height="42" align="center"class="tab">동의여부</td>
            </tr>
            <tr>
              <td width="220" height="50" align="center" class="tab2">회원제 서비스 이용 / 본인확인</td>
              <td width="338" height="50" align="center" class="tab2">이름, 아이디, 비밀번호, 생일, 성별, 이메일, 주소, 연락처, 휴대폰</td>
              <td width="174" height="50" align="center" class="tab2">회원탈퇴 후 5일까지</td>
              <td width="168" height="50" align="left" class="tab2"><label>
                <input type="radio" name="yaok1"  class="MS_input_radio yak_agree" value="Y" />
                동의합니다.</label>
                <p>
                  <label>
                    <input type="radio" name="yaok1"  class="MS_input_radio yak_agree" value="N" checked="checked" />
                    동의 하지 않습니다.</label>
                </td>
            </tr>
            <tr>
              <td height="30" colspan="4"> * 서비스 제공을 위한 최소한의 개인정보이므로 동의를 해주셔야 서비스를 이용하실 수 있습니다.</td>
            </tr>
            <tr>
              <td height="40" valign="bottom"><strong>[선택]</strong> 개인정보 수집·이용</td>
            </tr>
            <tr>
              <td height="20"></td>
            </tr>
            ...
            <tr>
              <td width="220" height="50" align="center" class="tab2">마케팅 활용(이벤트, 맞춤형 광고)</td>
              <td width="338" height="50" align="center" class="tab2">휴대폰, 이메일, 쿠키정보</td>
              <td width="174" height="50" align="center" class="tab2">회원탈퇴 후 5일까지</td>
              <td width="168" height="50" align="left" class="tab2"><label>
                <input type="radio" name="yaok2"  class="MS_input_radio yak_agree" value="Y" />
                동의합니다.</label>
                <p>
                  <label>
                    <input type="radio" name="yaok2"  class="MS_input_radio yak_agree" value="N" checked="checked" />
                    동의 하지 않습니다.</label>
                </td>
            </tr>
            <tr>
              <td height="30" colspan="4"> * 동의하지 않으셔도 쇼핑몰 서비스는 이용하실 수 있습니다.</td>
            </tr>
            <tr>
              <td height="40" valign="bottom"><strong>[선택]</strong> 광고성 정보 수신</td>
            </tr>
            <tr>
              <td height="20"></td>
            </tr>
            <tr>
              <td width="220" height="50" align="center" class="tab">광고성 정보 수신 동의</td>
              <td width="680" height="50" align="left" colspan="3" class="tab2"><label>
                <input type="radio" name="yaok3"  class="MS_input_radio yak_agree" value="Y" />
                동의합니다.</label>
                <label>
                  <input type="radio" name="yaok3"  class="MS_input_radio yak_agree" value="N" checked="checked" />
                  동의 하지 않습니다.</label></td>
            </tr>
            <tr>
              <td height="30" colspan="4"> * 동의하지 않으셔도 쇼핑몰 서비스는 이용하실 수 있습니다.</td>
            ...
            <tr>
              <td height="50" colspan="4" align="center" valign="bottom"><input type="submit" value="동의합니다">
                <input type="reset" value="거부합니다"></td>
            </tr>
            <tr>
            	<td height="30"></td></tr>
          </table></td>
