...
<!-- 드롭다운 끝 -->
  ...
  <%-- <tr>
    ...
    <td width="1064" height="51" align="left" valign="middle">${qna.qTitle } || <fmt:formatDate value="${qna.qDate}" /> || ${qna.qReadcount }</td>
    <td width="300" height="763" rowspan="5" align="left"></td>
  </tr> --%>
  <tr>
    <td width="300" height="763" rowspan="5" align="left"></td>
    <td width="236" height="51"></td>
    <td width="809" height="51" align="left" valign="middle">${qna.qTitle }</td>
    <td width="177" height="51" align="left" valign="middle"><fmt:formatDate value="${qna.qDate}" /></td>
    <td width="78" height="51" align="left" valign="middle">${qna.qReadcount }</td>
    <td width="300" height="763" rowspan="5" align="left"></td>
  </tr>
  <tr>
    <td width="1300" height="577" colspan="4" align="left" valign="top"><pre>${qna.qContext }</pre></textarea>
    </td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top" width="99"><%-- <img src="${contextPath}/images/sub05_03qna_questionBtn02.gif"> --%>
    	<input type="button" value="수정" onclick="location.href='${contextPath }/BoardServlet?command=board_update_form&qNo=${qna.qNo }'">
    	<input type="button" value="목록" onclick="location.href='${contextPath }/BoardServlet?command=board_list'">
    </td>
