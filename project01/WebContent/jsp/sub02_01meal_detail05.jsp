...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath}/images/sub02_01meal_detail05_kmg.gif); background-repeat:no-repeat; background-size:100% 100%;}
	body {font-family: 'Nanum Gothic', sans-serif; text-align:center;}
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_01 { background-image:url(${contextPath}/images/sub02_01meal_detail02_bg01.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	#bg_03 { background-image:url(${contextPath}/images/sub02_01meal_detail02_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_03{height:2384px; text-align:center;}
	#bg_04 { background-image:url(${contextPath}/images/sub02_01meal_detail02_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_04{height:136px; line-height:100px; text-align:center;}
	...
	#bg_05{height:1150px; line-height:600px; text-align:center;}
	...
	#bg_07 { background-image:url(${contextPath}/images/sub02_01meal_detail04_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_07{height:1500px; text-align:center;}
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
   ...
   <td align="center" valign="top"><img src="${contextPath}/images/sub02_menu_cafe.png" width="46" height="25" 
   onmouseover='this.src="${contextPath}/images/sub02_menu_cafe_r.png"' 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail05_startPic.gif" width="440" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail05_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="899"><img src="${contextPath}/images/sub02_01meal_detail05_pic02.gif" width="899" height="340"></td>
    <td align="center" valign="top" width="701"></td>
  </tr>
</table>
</td>
  </tr>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail05_pic03.gif" width="1500" height="657"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="420" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="591"></td>
    <td align="center" valign="top" width="693"><img src="${contextPath}/images/sub02_01meal_detail05_pic04.gif" width="693" height="420"></td>
    <td align="center" valign="top" width="616"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="2151" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail05_pic05.gif" width="1500" height="2151"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1500" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="139"></td>
    <td align="center" valign="top" width="1622"><img src="${contextPath}/images/sub02_01meal_detail05_pic06.gif" width="1622" height="1500"></td>
    <td align="center" valign="top" width="139"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="4011" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail05_pic07.gif" width="1500" height="4011"></td>
    <td align="center" valign="top" width="139"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail05_pic08.gif" width="1500" height="657"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="621"><img src="${contextPath}/images/sub02_01meal_detail02_pic09.gif" width="621" height="136"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="399" height="399" rowspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail05_pic09.gif" width="399" height="399"></td>
    <td width="26" height="399" rowspan="2" align="center" valign="top"></td>
    <td height="281" colspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail05_pic10.gif" width="646" height="281"></td>
    <td width="369" height="399" rowspan="2" align="center" valign="top"></td>
  </tr>
  <tr>
    <td width="170" height="118" align="left" valign="middle"><a class="effect effect-1" 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="219" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="733"></td>
    <td align="center" valign="top" width="440"><img src="${contextPath}/images/sub02_01meal_detail05_pic11.gif" width="440" height="219"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath}/images/sub02_01meal_detail04_pic12.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
