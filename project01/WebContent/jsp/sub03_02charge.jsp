...
<link rel="stylesheet" type="text/css" href="${contextPath}/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="${contextPath}/css/demo2.css" />
		<link rel="stylesheet" type="text/css" href="${contextPath}/css/set1.css" />
...
@media screen and (min-width:960px) {
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#charge_item table td img {display:block;}
	a:hover {color:#ff931e; font-size:15px; font-weight:bold; text-decoration:none;}
	.title { font-family:"나눔명조"; font-size:25px; font-weight:bolder;}
</style>
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
   ...
   <td align="center" valign="top"><img src="${contextPath}/images/sub03_menu_free.gif" width="48" height="25" 
   ...
   <td align="center" valign="top" width="781"></td>
    ...
    <li class="slide-container">
		<div class="slide">
			 <img src="${contextPath}/images/sub03_02charge_slide01.gif"/>
        </div>
		<div class="nav">
    ...
    <li class="slide-container">
        <div class="slide">
        <img src="${contextPath}/images/sub03_02charge_slide02.gif"/>
    ...
    <li class="slide-container">
        <div class="slide">
          <img src="${contextPath}/images/sub03_02charge_slide03.gif"/>
        </div>
		<div class="nav">
    ...
    <li class="slide-container">
        <div class="slide">
          <img src="${contextPath}/images/sub03_02charge_slide04.gif"/>
        </div>
		<div class="nav">
    ...
    <li class="slide-container">
        <div class="slide">
          <img src="${contextPath}/images/sub03_02charge_slide05.gif"/>
        </div>
		<div class="nav">
    ...
    <li class="slide-container">
        <div class="slide">
          <img src="${contextPath}/images/sub03_02charge_slide06.gif"/>
        </div>
		<div class="nav">
  ...
  <tr>
    <td align="center" valign="top"><table width="1900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top"><img src="${contextPath}/images/sub03_02charge_title.gif" width="470" height="25"></td>
  </tr>
</table>
</td>
  </tr>
...
<c:if test="${loginUser.mUserid=='admin' }">
	...
	onclick="location.href='${contextPath }/gProductServlet?command=gproduct_write_form'" style="cursor:pointer;">
</c:if>
<!-- 상품 등록 버튼 끝-->
...
<!-- 상품목록 시작 -->
 <div id="block4"></div>
 <%-- <div id="charge_item">
 <c:forEach var="gProList" items="${gProList }">
  <div class="grid">
	  	<figure class="effect-bubba">
			<img src="${contextPath }/jsp/upload/${gProList.gPicture }" alt="img02"/>
				<figcaption>
					<h2 class="title">${gProList.gTitle }</h2>
					<p>${gProList.gEx }</p>
					<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=${gProList.gNo}">View more</a>
				</figcaption>			
		</figure> 
  </div>
  </c:forEach>
<script>
  var container = document.querySelector( '#charge_item' );
 ...
 <!-- 상품 목록 끝 -->
  ...
  <tr>
    <td><div class="grid">
					<figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item01.gif" alt="img02"/>
						<figcaption>
							<h2 class="title">수원화성박물관</h2>
							<p>화성의 대표적인 박물관</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=1">View more</a>
						</figcaption>			
					</figure>      
 				 <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item02.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">시현추억의박물관</h2>
							<p>옛 추억을 떠올릴 수 있는 공간</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=2">View more</a>
						</figcaption>			
					</figure>   
                 <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item03.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">화성열차</h2>
							<p>화성을 여유있게 구경하고 싶다면</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=3">View more</a>
						</figcaption>			
					</figure>   
                    <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item04.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">수원시립아이파크미술관</h2>
							<p>가까운 곳에서 아름다움을 느끼세요</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=4">View more</a>
						</figcaption>			
					</figure>             
                    <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item05.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">열기구</h2>
							<p>공중에서 보는 화성이 궁금할때!</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=5">View more</a>
						</figcaption>			
					</figure>    
 				 <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item06.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">수원연무대활쏘기</h2>
							<p>누가누가 활을 잘쏘나~ <br>전통놀이 한마당</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=6">View more</a>
						</figcaption>			
					</figure>  
                 <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item07.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">화성행궁</h2>
							<p>수원하면 화성행궁 ONE TOP</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=7">View more</a>
						</figcaption>			
					</figure> 
                    <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item08.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">자전거대여</h2>
							<p>한적하게 자전거를 타고싶을때!</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=8">View more</a>
						</figcaption>			
					</figure>

                    <figure class="effect-bubba">
						<img src="${contextPath}/images/sub03_02charge_item09.gif" alt="img16"/>
						<figcaption>
							<h2 class="title">한복체험</h2>
							<p>우리나라 전통한복을 체험해보세요</p>
							<a href="${contextPath }/gProductServlet?command=gproduct_view&gNo=9">View more</a>
						</figcaption>			
					</figure>
				</div>  </td>
  </tr>
