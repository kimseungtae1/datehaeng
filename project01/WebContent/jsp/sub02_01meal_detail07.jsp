...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath}/images/sub02_01meal_detail07_kmg.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_03{height:1459px; text-align:center;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail07_startPic.gif" width="440" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail07_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="795"><img src="${contextPath}/images/sub02_01meal_detail07_pic02.gif" width="795" height="340"></td>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail07_pic03.gif" width="1500" height="657"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="989"><img src="${contextPath}/images/sub02_01meal_detail07_pic04.gif" width="989" height="420"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1196" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail07_pic05.gif" width="1500" height="1196"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath}/images/sub02_01meal_detail07_pic06.gif" width="1500" height="903"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1459" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1459"><img src="${contextPath}/images/sub02_01meal_detail07_pic07.gif" width="1561" height="1459"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="2896" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="139"></td>
    <td align="center" valign="top" width="1622"><img src="${contextPath}/images/sub02_01meal_detail07_pic08.gif" width="1622" height="2896"></td>
    <td align="center" valign="top" width="139"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="399" height="399" rowspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_01meal_detail07_pic09.gif" width="399" height="399"></td>
    <td width="26" height="399" rowspan="2" align="center" valign="top"></td>
    <td height="281" colspan="2" align="left" valign="top"><img src="${contextPath}/images/sub02_01meal_detail07_pic10.gif" width="646" height="281"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="441"><img src="${contextPath}/images/sub02_01meal_detail07_pic11.gif" width="441" height="219"></td>
    <td align="center" valign="top" width="701"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath}/images/sub02_01meal_detail07_pic12.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
