...
<body>
<form name="frm" method="post" action="BoardServlet_notice" onsubmit="return submitForm()">
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
    ...
    <td width="1064" height="51" align="left" valign="middle"><input type="text" size="100" id="subject" name="nTitle" placeholder="제목입력"></td>
    <td width="300" height="763" rowspan="5" align="left"></td>
  </tr>
  <tr>
    <td width="1300" height="577" colspan="2" align="left" valign="top">
    	<textarea rows="32" cols="170" name="nContext" placeholder="내용 입력"></textarea>
    </td>
    </tr>
  <tr>
    <td height="45" width="236"></td>
    <td width="1064" height="45" valign="middle"><input type="file" name="filename1"></td>
    </tr>
  <tr>
   <td height="45" width="236"></td>
    <td width="1064" height="45" valign="middle"><input type="password"></td>
    </tr>
  <tr>
    <td height="45" width="236"></td>
...
<div id="range">
  ...
  <tr>
    ...
    <td align="left" valign="top" width="99"><%-- <img src="${contextPath}/images/sub05_03qna_questionBtn02.gif"> --%>
    	<input type="image" src="${contextPath}/images/sub05_03qna_questionBtn02.gif"/>
    </td>
