...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath }/images/sub03_02charge_keyimg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_03 { background-image:url(${contextPath }/images/sub03_02charge_detail04_bg03.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_03{height:2168px; text-align:center;}
	#bg_04 { background-image:url(${contextPath }/images/sub03_02charge_detail04_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_04{height:1823px; line-height:100px; text-align:center;}
	#bg_05 { background-image:url(${contextPath }/images/sub03_02charge_detail04_bg05.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_05{height:1968px; text-align:center;}
	#bg_06 { background-image:url(${contextPath }/images/sub03_01free_detail01_bg07.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_06{height:136px; text-align:center;}
	#bg_07 { background-image:url(${contextPath }/images/sub02_01meal_detail01_bg04.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_07{height:1150px; line-height:600px; text-align:center;}
	#bg_08 { background-image:url(${contextPath }/images/sub_detail_review_bg.gif); background-repeat:no-repeat; background-size:100% 100%;}
	#bg_08{height:84px; text-align:center;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="675" height="241" align="center" valign="top"></td>
    <td width="570" height="241" align="center" valign="top"><img src="${contextPath }/images/sub03_02charge_detail04_startPic.gif" width="570" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath }/images/sub03_02charge_detail04_pic01.gif" width="1302" height="1775"></td>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1555"><img src="${contextPath }/images/sub03_02charge_detail04_pic02.gif" width="1555" height="657"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1498"><img src="${contextPath }/images/sub03_02charge_detail04_pic03.gif" width="1498" height="468"></td>
    <td align="center" valign="top" width="201"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="172"></td>
    <td align="center" valign="top" width="1555"><img src="${contextPath }/images/sub03_02charge_detail04_pic04.gif" width="1555" height="1126"></td>
    <td align="center" valign="top" width="173"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="2168" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub03_02charge_detail04_pic05.gif" width="1500" height="2168"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1823" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub03_02charge_detail04_pic06.gif" width="1500" height="1823"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1968" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub03_02charge_detail04_pic07.gif" width="1500" height="1968" usemap="#Map3"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="397" align="center" valign="top"><img src="${contextPath }/images/sub03_02charge_detail04_pic08.gif" width="983" height="397"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="440"><img src="${contextPath }/images/sub03_02charge_detail04_pic09.gif" width="440" height="253"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath }/images/sub03_02charge_detail04_pic10.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
...
<map name="Map2">
  <area shape="rect" coords="704,889,757,903" href="#">
</map>

<map name="Map3">
  <area shape="rect" coords="691,1954,748,1967" href="#">
</map>
</body>
</html>
