...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath}/images/sub02_02cafe_detail01_kmg.gif); background-repeat:no-repeat; background-size:100% 100%;}
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
   <td align="center" valign="top" width="765"></td>
    <td align="center" valign="top"><img src="${contextPath}/images/sub02_menu_meal.png" width="49" height="25" onmouseover='this.src="${contextPath}/images/sub02_menu_meal_r.png"' onmouseout='this.src="${contextPath}/images/sub02_menu_meal.png"' onclick="location.href='${contextPath }/mProductServlet?command=mproduct_list&mctype=1'" style="cursor:pointer;"></td>
...
<input type="hidden" name="mctype" value="2">
  ...
  <tr>
    <td height="87" align="center" valign="top"><strong>카페명</strong></td>
    <td width="263" height="87" align="left" valign="top"><p class="productTitle">${mprod.mTitle }</p></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath}/images/sub02_02cafe_detail01_startPic.gif" width="440" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath}/images/sub02_02cafe_detail01_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="586"><img src="${contextPath}/images/sub02_02cafe_detail01_pic02.gif" width="586" height="340"></td>
    <td align="center" valign="top" width="1014"></td>
  </tr>
</table>
</td>
  </tr>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1543"><img src="${contextPath}/images/sub02_02cafe_detail01_pic03.gif" width="1543" height="623"></td>
    <td align="center" valign="top" width="178"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="941"><img src="${contextPath}/images/sub02_02cafe_detail01_pic04.gif" width="941" height="468"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1189" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="198"></td>
    <td align="center" valign="top" width="1504"><img src="${contextPath}/images/sub02_02cafe_detail01_pic05.gif" width="1502" height="1189"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="940" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="230"></td>
    <td align="center" valign="top" width="1442"><img src="${contextPath}/images/sub02_02cafe_detail01_pic06.gif" width="1442" height="940"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="1158" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1482"><img src="${contextPath}/images/sub02_02cafe_detail01_pic07.gif" width="1487" height="1158"></td>
    <td align="center" valign="top" width="213"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="640"><img src="${contextPath}/images/sub02_02cafe_detail01_pic08.gif" width="640" height="136"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="399" height="399" rowspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_02cafe_detail01_pic09.gif" width="399" height="399"></td>
    <td width="26" height="399" rowspan="2" align="center" valign="top"></td>
    <td height="281" colspan="2" align="center" valign="top"><img src="${contextPath}/images/sub02_02cafe_detail01_pic010.gif" width="588" height="281"></td>
    <td width="426" height="399" rowspan="2" align="center" valign="top"></td>
  </tr>
  <tr>
    <td width="170" height="118" align="center" valign="top"><a class="effect effect-1" 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="440"><img src="${contextPath}/images/sub02_02cafe_detail01_pic12.gif" width="440" height="253"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath}/images/sub02_02cafe_detail01_pic14.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
