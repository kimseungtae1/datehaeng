...
<!-- 드롭다운 끝 -->
  ...
  <tr>
    ...
    <td align="center" valign="top" width="99"><img src="${contextPath }/images/sub05_03qna_questionBtn.gif" onclick="location.href='${contextPath }/BoardServlet?command=board_write_form'" style="cursor:pointer;"></td>
    <td align="center" valign="top" width="10"></td>
    <td align="left" valign="top"><form><select name="range">
    					<option value="hits">조회순</option>
                        <option value="ascDate">등록순</option></select></form></td>
  </tr>
</table>
</td>
  </tr>
 ...
 <td align="center" valign="middle" width="300"></td>
  ...
  <!-- DB에서 게시물 불러오는 부분 입니다. -->

  <c:forEach var="qna" items="${qnaList }">
	  <tr height="35">
		  <td align="center" valign="middle" width="300"></td>
		  <td align="center" valign="middle" width="203">${qna.qNo }</td>
		  <td align="left" valign="middle" width="667"><a class="hu" href="${contextPath }/BoardServlet?command=board_view&qNo=${qna.qNo}">${qna.qTitle }</a></td>
		  <td align="center" valign="middle" width="101">${qna.mUserid }</td>
		  <td align="center" valign="middle" width="167"><fmt:formatDate value="${qna.qDate }"/></td>
		  <td align="center" valign="middle" width="102">${qna.qReadcount }</td>
		  <td align="center" valign="middle" width="60"></td>
		  <td align="center" valign="middle" width="300"></td>
	  </tr>
  </c:forEach>
...
<div align="center">
	<form action="BoardServlet?command=board_list" method="post" name="sf">
		...
		<input type="radio" value="qTitle" name="column"> 제목 
		<input type="radio" value="qContext" name="column"> 내용 
		<input type="radio" value="mUserid" name="column"> 작성자 
		<input type="text" name="find" size="50" value="${find}">
		<input type="submit" value="검색">
		<script type="text/javascript">
			document.sf.column.value="${param.column}";
			console.log(document.sf.column.value);
		</script>
	</form>
</div>
	<!-- 검색 끝 -->
   ...
   <!--  페이지 번호 시작 -->
    <div id="block6"></div>
     <div id="list" align="center">
			...
			<c:if test="${pageNum > 1 }">
				<a class="hu" href="BoardServlet?command=board_list&pageNum=${pageNum-1 }&column=${param.column}&find=${find}">[이전]</a>&nbsp; 
			</c:if>
			...
			<c:if test="${pageNum < maxpage}">
				<a class="hu" href="BoardServlet?command=board_list&pageNum=${pageNum+1}&column=${param.column}&find=${find}">[다음]</a>
			</c:if>
    </div>
    <!--  페이지 번호 끝  -->
  <div id="block7"></div>
