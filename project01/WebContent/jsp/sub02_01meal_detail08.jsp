...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath }/images/sub02_01meal_detail08_kmg.gif); background-repeat:no-repeat; background-size:100% 100%;}
	...
	* { margin:0; padding:0; font-family: 'Nanum Gothic', sans-serif; font-size:15px;}
	...
	#bg_03 { background-image:url(${contextPath }/images/sub02_01meal_detail04_bg03.gif); background-repeat:no-repeat; background-size:100% 100%; height:4245px;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="440" height="241" align="center" valign="top"><img src="${contextPath }/images/sub02_01meal_detail08_startPic.gif" width="440" height="241"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top"><img src="${contextPath }/images/sub02_01meal_detail08_pic01.gif" width="1302" height="1435"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="795"><img src="${contextPath }/images/sub02_01meal_detail08_pic02.gif" width="795" height="340"></td>
...
<div id="bg_02">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub02_01meal_detail08_pic03.gif" width="1500" height="657"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="441"><img src="${contextPath }/images/sub02_01meal_detail08_pic04.gif" width="441" height="420"></td>
    <td align="center" valign="top" width="726"></td>
  </tr>
</table>
</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="2012" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="200"></td>
    <td align="center" valign="top" width="1500"><img src="${contextPath }/images/sub02_01meal_detail08_pic05.gif" width="1500" height="2012"></td>
    <td align="center" valign="top" width="200"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><table width="1900" height="4243" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top" width="139"></td>
    <td align="center" valign="top" width="1622"><img src="${contextPath }/images/sub02_01meal_detail08_pic06.gif" width="1622" height="4243"></td>
    <td align="center" valign="top" width="139"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="399" height="399" rowspan="2" align="center" valign="top"><img src="${contextPath }/images/sub02_01meal_detail08_pic07.gif" width="399" height="399"></td>
    <td width="26" height="399" rowspan="2" align="center" valign="top"></td>
    <td height="281" colspan="2" align="left" valign="top"><img src="${contextPath }/images/sub02_01meal_detail08_pic08.gif" width="646" height="281"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" width="441"><img src="${contextPath }/images/sub02_01meal_detail08_pic09.gif" width="441" height="219"></td>
    <td align="center" valign="top" width="701"></td>
  </tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center" valign="top" width="300"></td>
    <td align="center" valign="top" width="1300"><img src="${contextPath }/images/sub02_01meal_detail08_pic10.png" width="1300" height="1150"></td>
    <td align="center" valign="top" width="300"></td>
  </tr>
</table>
</td>
