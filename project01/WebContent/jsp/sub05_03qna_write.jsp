...
<script type="text/javascript">
	function submitForm(){
		 var f = document.frm; // 폼 이름 
	       if(document.frm.qTitle.value == "") 
	       { 
	        alert('제목을 입력해주세요!'); 
	        return false; // 폼 전송 안함. 
	       }
	       if(document.frm.qContext.value == "") 
	       { 
	        alert('내용을 입력해주세요!'); 
	        return false; // 폼 전송 안함. 
	       } 
	       if(document.frm.secret == undefined) 
	       { 
	        alert('공개여부를 선택해주세요!'); 
	        return false; // 폼 전송 안함. 
	       } 
...
@media screen and (min-width:960px) {
	...
	#keyimg { background-image:url(${contextPath}/images/sub05_03qna_keyimage.gif); background-repeat:no-repeat; background-size:100% 100%;}
...
<body>
<form name="frm" method="post" action="BoardServlet" onsubmit="return submitForm()">
...
<!-- 드롭다운 끝 -->
  ...
  <tr>
   ...
   <td align="center" valign="top"><img src="${contextPath}/images/sub05_menu_notice.png" width="99" height="25" onmouseover='this.src="${contextPath}/images/sub05_menu_notice_r.png"' onmouseout='this.src="${contextPath}/images/sub05_menu_notice.png"'></td>
   <td align="center" valign="top" width="285"></td>
   <td align="center" valign="top"><img src="${contextPath}/images/sub05_menu_event.png" width="69" height="25" onmouseover='this.src="${contextPath}/images/sub05_menu_event_r.png"' onmouseout='this.src="${contextPath}/images/sub05_menu_event.png"'></td>
   <td align="center" valign="top" width="321"></td>
   <td align="center" valign="top"><img src="${contextPath}/images/sub05_menu_qna_r.png" width="99" height="25"></td>
  ...
  <tr>
    <td align="center" valign="top"><table width="1900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top"><img src="${contextPath}/images/sub05_03qna_title.gif" width="422" height="29"></td>
  </tr>
</table>
</td>
  </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><table width="1900" border="0" cellspacing="0" cellpadding="0" background="${contextPath}/images/sub05_table_write2.gif">
  <tr>
    <td width="300" height="763" rowspan="5" align="left"></td>
    <td width="236" height="51"></td>
    <td width="1064" height="51" align="left" valign="middle"><input type="text" size="100" id="subject" name="qTitle" placeholder="제목입력"></td>
    <td width="300" height="763" rowspan="5" align="left"></td>
  </tr>
  <tr>
    <td width="1300" height="577" colspan="2" align="left" valign="top">
    	<textarea rows="32" cols="170" name="qContext" placeholder="[비회원으로문의글을 남겨주시면 안내가 어렵습니다. 주문번호 또는 핸드폰번호 기재부탁드립니다]
주문자의 성함 혹은 입금 예정자와 실제 입금자의성함(공백주의), 주문서의 입금액 입금 은행이 모두 일치해야만 입금 확인이 완료됩니다."></textarea>
    </td>
    </tr>
  <tr>
    <td height="45" width="236"></td>
    <td width="1064" height="45" valign="middle"><input type="file" value="찾아보기"></td>
    </tr>
  <tr>
   <td height="45" width="236"></td>
    <td width="1064" height="45" valign="middle"><input type="password" name="pass"></td>
    </tr>
  <tr>
    <td height="45" width="236"></td>
    <td height="45" width="1064"><label><input type="radio" name="secret"  class="MS_input_radio yak_agree" value="Y" />공개</label>
                <label><input type="radio" name="secret"  class="MS_input_radio yak_agree" value="N"/>비공개</label></td>
    </tr>
</table>
</td>
  </tr>
  ...
  <tr>
    <td align="center" valign="top"><table width="1900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" valign="top" width="1501"></td>
    <td align="left" valign="top" width="99"><%-- <img src="${contextPath}/images/sub05_03qna_questionBtn02.gif"> --%>
    	<input type="image" src="${contextPath}/images/sub05_03qna_questionBtn02.gif"/>&nbsp;&nbsp;<!-- <input type="button" value="목록" 
