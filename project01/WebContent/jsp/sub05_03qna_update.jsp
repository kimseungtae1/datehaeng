...
<!-- 드롭다운 끝 -->
  ...
  <tr>
    ...
    <td width="809" height="51" align="left" valign="middle"><input type="text" size="80" id="subject" name="qTitle" value="${qna.qTitle}"></td>
    <td width="177" height="51" align="left" valign="middle"><fmt:formatDate value="${qna.qDate}" /></td>
    <td width="78" height="51" align="left" valign="middle"><input type="hidden" size="100" id="subject" name="qReadcount" value="${qna.qReadcount}">${qna.qReadcount }</td>
    <td width="300" height="763" rowspan="5" align="left"></td>
  </tr>
  <tr>
    <td width="1300" height="577" colspan="4" align="left" valign="top">
    	<textarea rows="32" cols="170" name="qContext" placeholder=${qna.qContext}></textarea>
    </td>
    </tr>
  <tr>
