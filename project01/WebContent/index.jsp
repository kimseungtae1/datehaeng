...
<link href="css/index_arrow.css" rel="stylesheet" type="text/css">
...
.page2 {	background:url('images/index_sub01_keyimg.gif') 50% 50% no-repeat; 
			background-size:cover;}
.page3 {	background:url('images/index_sub02_keyimg.gif') 50% 50% no-repeat; 
			background-size:cover;}
.page4 {	background:url('images/index_sub03_keyimg.gif') 50% 50% no-repeat; 
			background-size:cover;}
.page5 {	background:url('images/index_sub04_keyimg.gif') 50% 50% no-repeat; 
			background-size:cover;}
.page6 {	background:url('images/index_sub05_keyimg.gif') 50% 50% no-repeat; 
			background-size:cover;}
...
<div class="arrow"><a href="#2">	<!--하단 화살표 아이콘 div 생성-->
    ...
    <img src="images/subMenuBtn.png" onmouseover='this.src="images/subMenuBtn_01dateHaeng.png"' onmouseout='this.src="images/subMenuBtn.png"' 
    onclick="location.href='jsp/sub01_dateHaeng.jsp'" style="cursor:pointer;">
   </div>
    <div class="subMealBtn">
    <img src="images/subMenuBtn.png" onmouseover='this.src="images/subMenuBtn_02meal.png"' onmouseout='this.src="images/subMenuBtn.png"' 
    onclick="location.href='${contextPath }/mProductServlet?command=mproduct_list&mctype=1'" style="cursor:pointer;">
    </div>
      <div class="subEnjoyBtn">
    <img src="images/subMenuBtn.png" onmouseover='this.src="images/subMenuBtn_03enjoy.png"' onmouseout='this.src="images/subMenuBtn.png"' 
    onclick="location.href='${contextPath }/fProductServlet?command=fproduct_list'" style="cursor:pointer;">
    </div>
    <div class="subHumancityBtn">
    <img src="images/subMenuBtn.png" onmouseover='this.src="images/subMenuBtn_04humancity.png"' onmouseout='this.src="images/subMenuBtn.png"' 
    onclick="location.href='jsp/sub04_humancity.jsp'" style="cursor:pointer;">
    </div>
    <div class="subCommunityBtn">
    <img src="images/subMenuBtn.png" onmouseover='this.src="images/subMenuBtn_05community.png"' onmouseout='this.src="images/subMenuBtn.png"' 
    onclick="location.href='${contextPath }/BoardServlet_notice?command=board_list'" style="cursor:pointer;">
    </div>
</div>
